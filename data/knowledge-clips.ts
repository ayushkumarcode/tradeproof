export type PostType = "article" | "tip" | "story";
...
export interface KnowledgeClip {
  ...
  content: string;
  buildingEra?: string;
  /** ISO date string; used for feed order and LinkedIn-style dates */
  publishedAt: string;
  /** Optional hero/feature image for blog-style posts */
  imageUrl?: string;
  /** article = blog-style with optional image; tip = short insight; story = personal anecdote */
  postType?: PostType;
}

/** Placeholder images (electrical/industrial) — replace with your own assets if needed */
const IMG = {
  panel:
